...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v1/addUser" , "/api/v1/updateUser/{id}" , "http://localhost:3000/api/v1/getAll" , "/api/v1/addUser" , "/api/v1/deleteUserById/{id}" , "http://localhost:3000/add-User" , "/api/v1/addEventeAndasignToUser/{id}").hasAnyAuthority("ADMIN")
